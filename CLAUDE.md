...
dj-rest-jwt is a Django REST Framework package providing authentication API endpoints (login, logout, registration, password reset/change, JWT auth). It integrates with django-allauth for social auth and registration.
...
# Single test
DJANGO_SETTINGS_MODULE=dj_rest_jwt.tests.settings python -m django test dj_rest_jwt.tests.test_api.APIBasicTests.test_login
