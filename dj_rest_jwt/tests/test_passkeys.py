...
from dj_rest_jwt.tests.mixins import APIClient, TestsMixin
...
class PasskeyRegistrationTests(TestsMixin, TestCase):
    ...
    @patch('dj_rest_jwt.passkeys.serializers.generate_registration_options')
    ...
    @patch('dj_rest_jwt.passkeys.serializers.verify_registration_response')
    @patch('dj_rest_jwt.passkeys.serializers.generate_registration_options')
