...
from dj_rest_jwt.jwt_auth import get_refresh_view
from dj_rest_jwt.registration.views import (
...
from dj_rest_jwt.social_serializers import (
    TwitterConnectSerializer, TwitterLoginSerializer,
)
from dj_rest_jwt.urls import urlpatterns
...
urlpatterns += [
    re_path(r'^rest-registration/', include('dj_rest_jwt.registration.urls')),
    ...
    re_path(r'^passkeys/', include('dj_rest_jwt.passkeys.urls')),
